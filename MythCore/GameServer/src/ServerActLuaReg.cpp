...
void CServerActLuaReg::reglua()
{
	...
	lua_tinker::def(L, "getServerActModuleInst", &CServerActModule::Inst);

	lua_tinker::class_add<CServerActModule>(L, "CServerActModule");
	lua_tinker::class_def<CServerActModule>(L, "initActivityTypeFunc", &CServerActModule::initActivityTypeFunc);
